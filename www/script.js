...
(function () {
  ...
  const translations = {
    de: {
      ...
      hero_subtitle: "markpublish setzt Markdown-Kapitel in druckreife, hochwertige PDFs. Struktur, Metadaten und Design leben in einem einzigen <code>markpublish.yaml</code> — alles andere ist reiner Text.",
      hero_btn_manuals: "Handbücher & Quickstart",
      copied: "Kopiert!",
      hi_deps: "Keine externen Compiler-Binaries",
      hi_speed: "Sub-100ms Kompilierung",
      hi_license: "Freie MIT-Lizenz",

      showcase_tag: "VON DER IDEE ZUR PUBLIKATION",
      showcase_title: "Markdown eingeben. Druckreifes PDF erhalten.",
      showcase_desc: "markpublish schließt die Lücke zwischen leichtem Markdown und typografischer Buchdruck-Perfektion.",
    ...
    en: {
      ...
      hero_subtitle: "markpublish typesets Markdown chapters into print-ready, publication-grade PDFs. Structure, metadata, and styling live in a single <code>markpublish.yaml</code> — everything else is your prose.",
      hero_btn_manuals: "Manuals & Quickstart",
      copied: "Copied!",
      hi_deps: "Zero external compiler binaries",
      hi_speed: "Sub-100ms compilation",
      hi_license: "Permissive MIT License",

      showcase_tag: "FROM CONCEPT TO PUBLICATION",
      showcase_title: "Write Markdown. Receive Print-Ready PDF.",
      showcase_desc: "markpublish bridges the gap between lightweight Markdown drafting and exquisite typographical book printing.",
